...
pub const CHIP8: &'static [Definition] = &[
    ...
    Definition { pattern: [C(0x8), A(A1|A3), A(A3),    C(0x3)], op: Xor(DestKind::Register, SrcKind::Register, SrcKind::Register) },
    Definition { pattern: [C(0x8), A(A1|A3), A(A3),    C(0x4)], op: Add(DestKind::Register, SrcKind::Register, SrcKind::Register) },
    Definition { pattern: [C(0x8), A(A1|A3), A(A3),    C(0x5)], op: Sub(DestKind::Register, SrcKind::Register, SrcKind::Register) },
